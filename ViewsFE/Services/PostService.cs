...
//            var posts = JsonConvert.DeserializeObject<List<Product_Posts>>(response);
...
//        public async Task<List<Product_Posts>> SearchPosts(string keyword)
//        {
//            var response = await _httpClient.GetAsync($"https://localhost:7011/api/Posts/search?keyword={Uri.EscapeDataString(keyword)}");
//            if (response.IsSuccessStatusCode)
//            {
//                return await response.Content.ReadFromJsonAsync<List<Product_Posts>>();
//            }
//            return new List<Product_Posts>();
//        }

//        public async Task<Product_Posts> GetById(long postId)
//        {
//            var response = await _httpClient.GetAsync($"https://localhost:7011/api/Posts/posts-get-id?id={postId}");
//            if (response.IsSuccessStatusCode)
//            {
//                return await response.Content.ReadFromJsonAsync<Product_Posts>();
//            }
//            return null;
//        }
...
//        public async Task Create(Product_Posts post)
//        {
...
//            var createdPost = JsonConvert.DeserializeObject<Product_Posts>(createdPostJson);
