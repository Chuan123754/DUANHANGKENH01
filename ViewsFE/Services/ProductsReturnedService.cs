...
namespace ViewsFE.Services
{
    public class ProductsReturnedService : IProductsReturnedService
    {
        ...
        public async Task<bool> ProcessReturnQuantityAsync(long orderDetailId, int returnQuantity, long roductReturnedId)
        {
            var response = await _httpClient.PutAsJsonAsync(
                $"https://localhost:7011/api/ProductsReturned/ProcessReturnQuantity",
                new { OrderDetailId = orderDetailId, ReturnQuantity = returnQuantity, ProductReturnedId = roductReturnedId }
            );
        ...
        public async Task<bool> ProcessRefundQuantityAsync(long orderDetailId, int returnQuantity, long roductReturnedId)
        {
            var response = await _httpClient.PutAsJsonAsync(
