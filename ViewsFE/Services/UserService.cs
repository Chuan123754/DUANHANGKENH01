...
namespace AppViews.Services
{
    public class UserService : IUserService
    {
        ...
        {
            string requestURL = "https://localhost:7015/api/Users/Users-get";
        ...
        {
            string requestURL = $"https://localhost:7015/api/Users/Users-get-id?id={id}";
            var response = await _httpClient.GetStringAsync(requestURL);
        ...
        public async Task Create(Users user)
        {
            ...
            string userRequestURL = "https://localhost:7015/api/Users/Users-post";
            ...
            string cartRequestURL = "https://localhost:7015/api/Carts/carts-post";
        ...
        {
            string requestURL = "https://localhost:7015/api/Users/Users-put";
        ...
        {
            string requestURL = $"https://localhost:7015/api/Users/Users-delete?id={id}";
        ...
        public async Task<bool> IsEmailExists(string email)
        {
            try
            {
                string requestURL = $"https://localhost:7015/api/Users/Users-get-email?email={email}";
                var response = await _httpClient.GetStringAsync(requestURL);
        ...
        public async Task<bool> IsPhoneExists(string phone)
        {
            try
            {
                string requestURL = $"https://localhost:7015/api/Users/Users-get-phone?phone={phone}";
                var response = await _httpClient.GetStringAsync(requestURL);
                var user = JsonConvert.DeserializeObject<Users>(response);
                return user != null;
            }
