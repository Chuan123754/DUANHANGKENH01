        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    P_attribute_Id = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ADMIN_ROLE_ID", "5dc15095-d762-4509-b70a-2186bb6f3480", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "DESIGNER_ROLE_ID", "fb74c56b-2308-4992-80eb-670868f49901", "Designer", "DESIGNER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "EMPLOYEE_ROLE_ID", "497daf85-f8f5-4fad-89c9-7c6f1109da68", "Employee", "EMPLOYEE" });
